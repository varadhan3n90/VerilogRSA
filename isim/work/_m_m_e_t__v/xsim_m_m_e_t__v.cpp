...
va_list vap)
{
    extern HSim__s6 * createworkM_m_m_e_t__v(const char*);
    HSim__s6 *blk = createworkM_m_m_e_t__v(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createworkM_m_m(const char*);
    HSim__s6 *blk = createworkM_m_m(label); 
    return blk;
}
...
va_list vap)
{
    ...
    HSim__s6 *blk = createworkM_m_m_e(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","MMET_v", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("work","MM", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("work","MME", (HSimInstFactoryPtr)IF2);
        (*cfgvh).addVlogModule("work","glbl", (HSimInstFactoryPtr)IF3);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkM_m_m_e_t__v(const char*);
        topvl = (HSim__s5*)createworkM_m_m_e_t__v("MMET_v");
